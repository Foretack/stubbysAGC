...
public class ContentDisplay{
    ...
    public static void displayBlock(Table table, Block block){
        ...
        table.addImage().height(3).color(Color.navy).pad(8).padLeft(0).padRight(0).fillX();
        ...
        if(block.description != null){
            ...
            table.addImage().height(3).color(Color.sky).pad(8).padLeft(0).padRight(0).fillX();
            table.row();
        }
    ...
    public static void displayItem(Table table, Item item){
        ...
        table.addImage().height(3).color(Color.navy).pad(15).padLeft(0).padRight(0).fillX();
        ...
        if(item.description != null){
            ...
            table.addImage().height(3).color(Color.sky).pad(15).padLeft(0).padRight(0).fillX();
            table.row();
        }
