...
public class Sounds {
  ...
  public static Sound eSwing = new arc.mock.MockSound();
  ...
  public static Sound hint = new arc.mock.MockSound();
  ...
  public static void load() {
    ...
    arc.Core.assets.load(arc.Core.app.getType() != arc.Application.ApplicationType.iOS ? "sounds/hint.wav" : "sounds/hint.wav", arc.audio.Sound.class).loaded = a -> hint = (arc.audio.Sound)a;
  ...
  public static void dispose() {
    ...
    flame2 = null;
    arc.Core.assets.unload(arc.Core.app.getType() != arc.Application.ApplicationType.iOS ? "sounds/hint.wav" : "sounds/hint.wav");
    hint = null;
